...
class Army:
    """
    Association Squard in the army with specific characteristics:
    """
    __squads = None
    __health = None
    __name_army = None
    ...
    def take_damage(damage, strategy_name, army):
        """
        Take damage army depending on the chosen strategy
        :param damage: damage
        :param strategy_name: How strategy chosen
        :param army: army which will be attacked
        :return: squad which attacked
        """
